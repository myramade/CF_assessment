...
export const personalities: Record<string, Personality> = {
  D: {
    ...
    values: ["Achievement", "Independence", "Challenge", "Efficiency"],
    recommendedJobs: [
      "CEO",
      "Operations Manager",
  ...
  I: {
    ...
    values: ["Collaboration", "Recognition", "Creativity", "Relationships"],
    recommendedJobs: [
  ...
  S: {
    ...
    values: ["Stability", "Harmony", "Loyalty", "Cooperation"],
    recommendedJobs: [
  ...
  C: {
    ...
    values: ["Accuracy", "Quality", "Expertise", "Logic"],
    recommendedJobs: [
      "Data Analyst",
      "Financial Analyst",
      "Software Engineer",
  ...
  DI: {
    ...
    values: ["Innovation", "Influence", "Achievement", "Collaboration"],
    recommendedJobs: [
      "Product Manager",
      "Marketing Director",
      "Business Development Manager",
  ...
  DS: {
    ...
    values: ["Progress", "Stability", "Achievement", "Reliability"],
    recommendedJobs: [
      "Operations Manager",
      "Project Coordinator",
      "Production Manager",
  ...
  DC: {
    ...
    values: ["Excellence", "Precision", "Strategy", "Achievement"],
    recommendedJobs: [
      "CEO",
      "Financial Director",
      "Operations Manager",
  ...
  IS: {
    ...
    values: ["Relationships", "Harmony", "Collaboration", "Support"],
    recommendedJobs: [
      "HR Manager",
      "Teacher",
      "Counselor",
  ...
  IC: {
    ...
    values: ["Creativity", "Accuracy", "Innovation", "Excellence"],
    recommendedJobs: [
  ...
  SC: {
    ...
    values: ["Quality", "Reliability", "Process", "Teamwork"],
    recommendedJobs: [
